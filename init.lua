...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      --      vim.keymap.set('n', '<leader>s.', builtin.oldfiles, { desc = '[S]earch Rcent Files ("." for repeat)' })
      ...
      end, { desc = 'Searhc in the project' })
      ...
      vim.keymap.set('n', '<leader>t', ':NvimTreeOpen<CR>', { desc = 'Open file tree' })
